		...
		*/
		public static String read(String name)
		{
			...
			try{
                ...
                //novo - 24/04/18
                public static void editLine(String caminho, int linha, String texto) {

                   String[] array = arky.files.read(caminho).split("\\n");//cria um array separando por linhas
                   array[linha-1]=texto;//edita o array na linha desejada
                   arky.files.write(caminho, "", false);//cria o arquivo vazio
                   for(int i=0; i<array.length; i++){
                      arky.files.write(caminho, array[i]+"\n", true);
                   }
                } 
		...
		*/
		public static void open(String file)
		{
			try{
                ...
                public static boolean download(String urlserver, String local){
                    try {
                ...
                public static boolean upload(String urlserver, String arq){
                    try {
                        URL url = new URL(urlserver);
                        URLConnection conn=url.openConnection();
...
//							changed code and comments' language to english;
